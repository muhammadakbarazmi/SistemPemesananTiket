  ...
  <head>
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="pelanggan/assets/images/slide-03.jpg" alt="">
                <div class="text-content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="pelanggan/assets/images/service-item-01.png" alt="">
                                    <h4>Top Notch</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="pelanggan/assets/images/contact-info-03.png" alt="">
                                    <h4>Reliable</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <div class="features-item">
                        <div class="features-icon">
                            <img src="pelanggan/assets/images/features-icon-1.png" alt="">
                        </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/seribuBintang.jpg" height="400" alt="">
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/member-item-04.jpg" height="400" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/member-item-02.jpg" alt="" >
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/member-item-05.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/member-item-03.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/member-item-04.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="pelanggan/assets/images/member-item-06.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
